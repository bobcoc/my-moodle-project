...
$ADMIN->add('accounts', new admin_externalpage('tooluploaduserpicturesbatch', get_string('uploadpicturesbatch','tool_uploaduser'), "$CFG->wwwroot/$CFG->admin/tool/uploaduser/picture_batch.php", 'tool/uploaduser:uploaduserpictures'));
